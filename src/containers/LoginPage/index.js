  ...
  return (
    <div className="login">
      <div className="login__left">
        ...
        <form autocomplete="off" id="login__form" className="login__form" onSubmit={loginSubmit} >
            <div className="login__information">
                <div className="login__email">
                    <label for="email" className="login__label login__label--input">Email</label>
                    <input type="email" id="email" className="login__input" required placeholder="Email" defaultValue={user.email} onChange={onChangeInput}/>
                </div>
                <div className="login__password">
                    <label for="password" className="login__label login__label--input">Password</label>
                    <input type="password" id="password" className="login__input" required placeholder="Password" defaultValue={user.password} onChange={onChangeInput} />
                </div>
            </div>
